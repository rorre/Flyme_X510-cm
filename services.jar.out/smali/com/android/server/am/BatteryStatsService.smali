...
.method updateExternalStatsSync(Ljava/lang/String;I)V
    ...
    .line 1460
    :try_start_2
    new-instance v19, Landroid/os/SynchronousResultReceiver;

    invoke-direct/range {v19 .. v19}, Landroid/os/SynchronousResultReceiver;-><init>()V
    :try_end_2
    ...
    .local v19, "wifiReceiver":Landroid/os/SynchronousResultReceiver;
    :try_start_3
    move-object/from16 v0, p0
    ...
    .line 1468
    .end local v19    # "wifiReceiver":Landroid/os/SynchronousResultReceiver;
    :cond_2
    :goto_0
    ...
    .line 1483
    .local v17, "wifiInfo":Landroid/net/wifi/WifiActivityEnergyInfo;
    const/4 v11, 0x0
    ...
    :try_start_7
    invoke-static/range {v18 .. v18}, Lcom/android/server/am/BatteryStatsService;->awaitControllerInfo(Landroid/os/SynchronousResultReceiver;)Landroid/os/Parcelable;
    ...
    .line 1492
    .end local v17    # "wifiInfo":Landroid/net/wifi/WifiActivityEnergyInfo;
    :goto_1
    :try_start_8
    ...
    .line 1508
    invoke-virtual/range {v17 .. v17}, Landroid/net/wifi/WifiActivityEnergyInfo;->isValid()Z
    ...
    .restart local v17    # "wifiInfo":Landroid/net/wifi/WifiActivityEnergyInfo;
    :catch_0
    move-exception v15
    ...
    .restart local v19    # "wifiReceiver":Landroid/os/SynchronousResultReceiver;
    :catchall_2
    move-exception v3
