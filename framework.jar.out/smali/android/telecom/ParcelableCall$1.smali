...
.method public createFromParcel(Landroid/os/Parcel;)Landroid/telecom/ParcelableCall;
    ...
    .line 295
    .local v15, "handle":Landroid/net/Uri;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readInt()I

    move-result v16

    .line 296
    .local v16, "handlePresentation":I
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 298
    .local v18, "callerDisplayNamePresentation":I
    move-object/from16 v0, p1
    ...
    check-cast v19, Landroid/telecom/GatewayInfo;

    .line 299
    .local v19, "gatewayInfo":Landroid/telecom/GatewayInfo;
    move-object/from16 v0, p1
    ...
    check-cast v20, Landroid/telecom/PhoneAccountHandle;

    .line 300
    .local v20, "accountHandle":Landroid/telecom/PhoneAccountHandle;
    ...
    .line 302
    .local v21, "isVideoCallProviderChanged":Z
    :goto_0
    ...
    .line 303
    .local v22, "videoCallProvider":Lcom/android/internal/telecom/IVideoProvider;
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 313
    .local v12, "supportedAudioRoutes":I
    new-instance v3, Landroid/telecom/ParcelableCall;

    invoke-direct/range {v3 .. v29}, Landroid/telecom/ParcelableCall;-><init>(Ljava/lang/String;ILandroid/telecom/DisconnectCause;Ljava/util/List;IIJIJLandroid/net/Uri;ILjava/lang/String;ILandroid/telecom/GatewayInfo;Landroid/telecom/PhoneAccountHandle;ZLcom/android/internal/telecom/IVideoProvider;Ljava/lang/String;Ljava/util/List;Landroid/telecom/StatusHints;ILjava/util/List;Landroid/os/Bundle;Landroid/os/Bundle;)V

    return-object v3

    .line 300
    .end local v12    # "supportedAudioRoutes":I
    .end local v21    # "isVideoCallProviderChanged":Z
    .end local v22    # "videoCallProvider":Lcom/android/internal/telecom/IVideoProvider;
    ...
    .restart local v21    # "isVideoCallProviderChanged":Z
    goto :goto_0
.end method
