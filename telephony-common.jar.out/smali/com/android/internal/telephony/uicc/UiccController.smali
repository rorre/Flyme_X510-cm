...
.method private constructor <init>(Landroid/content/Context;[Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    invoke-interface {v4, p0, v6, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForIccStatusChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v6, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForAvailable(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForNotAvailable(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForIccRefresh(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForVirtualSimOn(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForVirtualSimOff(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForSimMissing(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForSimRecovery(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForCommonSlotNoChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v5, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForSessionChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v4, p0, v6, v2}, Lcom/android/internal/telephony/CommandsInterface;->registerForOn(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private declared-synchronized onGetIccCardStatusDone(Landroid/os/AsyncResult;Ljava/lang/Integer;Z)V
    ...
    const-string/jumbo v3, "Error getting ICC status. RIL_REQUEST_GET_ICC_STATUS should never return an error"
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/uicc/UiccController;->isValidCardIndex(I)Z
    ...
    const-string/jumbo v4, "onGetIccCardStatusDone: invalid index : "
    ...
    const-string/jumbo v3, "onGetIccCardStatusDone, index "
    ...
    const-string/jumbo v3, "isUpdateSiminfo "
    ...
    const-string/jumbo v3, "new UiccApplication index="
    ...
    new-instance v4, Lcom/android/internal/telephony/uicc/UiccCard;
    ...
    invoke-direct {v4, v5, v6, v1, v7}, Lcom/android/internal/telephony/uicc/UiccCard;-><init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/uicc/IccCardStatus;I)V

    aput-object v4, v2, v3

    .line 656
    :goto_0
    const-string/jumbo v2, "Notifying IccChangedRegistrants"

    invoke-direct {p0, v2}, Lcom/android/internal/telephony/uicc/UiccController;->log(Ljava/lang/String;)V

    .line 658
    const-string/jumbo v2, "ro.mtk_sim_hot_swap_common_slot"
    ...
    const-string/jumbo v3, "update UiccApplication index="
    ...
    invoke-virtual {v2, v3, v4, v1, p3}, Lcom/android/internal/telephony/uicc/UiccCard;->update(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/uicc/IccCardStatus;Z)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :sswitch_0
    :try_start_2
    const-string/jumbo v17, "Received EVENT_ICC_STATUS_CHANGED, calling getIccCardStatus"
    ...
    const-string/jumbo v19, "Exception on refresh "
